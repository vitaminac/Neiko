    ...
    public static void setLabelText(String text, int dtype, LabelImageView iv) {
        if (!TextUtils.isEmpty(text)) {
            ...
            switch (dtype) {
                ...
                case 2:
                case 6:
                    color = ContextCompat.getColor(iv.getContext(), R.color.brown_500);
                    break;  //brown_500
                case 3:
                case 7:
                    color = ContextCompat.getColor(iv.getContext(), R.color.green_500);
                    break;  //green_500
                default:
                    color = ContextCompat.getColor(iv.getContext(), R.color.deep_purple_500);
                    break;  //deep_purple_500
            }
            iv.setLabelBackgroundColor(color);
        }
    }
}
